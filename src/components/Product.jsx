...
const Product = ({ post }) => {
  ...
  return (
    ...
    <div className="flex flex-col items-center hover:scale-110 transition duration-300 ease-in rounded-xl gap-3 p-4 mt-10  ml-5 border
    hover:shadow-lg
    ">
      <div>
      ...
      <div className="flex justify-between gap-12 items-center w-full mt-5">
        <div>
          <p className="text-green-600 font-semibold ite">${post.price}</p>
        </div>
